...
!function(n) {
    ...
    (e = t && t.fn && t.fn.select2 && t.fn.select2.amd ? t.fn.select2.amd : e) && e.requirejs || (e ? n = e : e = {},
    g = {},
    m = {},
    y = {},
    v = {},
        ...
        s.Decorate = function(s, i) {
            ...
            for (var a = 0; a < e.length; a++) {
                ...
                o.prototype[l] = function(e) {
                    var t = function() {}
                      , n = (e in o.prototype && (t = o.prototype[e]),
                    i.prototype[e]);
                    return function() {
    ...
    e.define("select2/results", ["jquery", "./utils"], function(u, d) {
        ...
        return d.Extend(s, d.Observable),
        ...
        s.prototype.option = function(e) {
            var t, n = document.createElement("li"), s = (n.classList.add("select2-results__option"),
            n.classList.add("select2-results__option--selectable"),
            {
                role: "option"
            }), i = window.Element.prototype.matches || window.Element.prototype.msMatchesSelector || window.Element.prototype.webkitMatchesSelector;
            for (t in (null != e.element && i.call(e.element, ":disabled") || null == e.element && e.disabled) && (s["aria-disabled"] = "true",
            ...
            if (e.children) {
                for (var i = u(n), o = document.createElement("strong"), r = (o.className = "select2-results__group",
                this.template(e, o),
        ...
        s.prototype.bind = function(t, e) {
            ...
            t.on("results:select", function() {
                ...
                0 !== t.length && (e = d.GetData(t[0], "data"),
            ...
            t.on("results:next", function() {
                var e, t, n = i.getHighlightedResults(), s = i.$results.find(".select2-results__option--selectable"), n = s.index(n) + 1;
                n >= s.length || ((s = s.eq(n)).trigger("mouseenter"),
    ...
    e.define("select2/selection/single", ["jquery", "./base", "../utils", "../keys"], function(e, t, n, s) {
        ...
        i.prototype.bind = function(t, e) {
            var n = this
              , s = (i.__super__.bind.apply(this, arguments),
            t.id + "-container");
    ...
    e.define("select2/selection/multiple", ["jquery", "./base", "../utils"], function(i, e, c) {
        ...
        o.prototype.bind = function(e, t) {
            var n = this
              , s = (o.__super__.bind.apply(this, arguments),
            e.id + "-container");
            ...
            0 !== e.length) {
                for (var t = [], n = this.$selection.find(".select2-selection__rendered").attr("id") + "-choice-", s = 0; s < e.length; s++) {
                    var i = e[s]
                      ...
                      , r = (i.id ? a += i.id : a += c.generateChars(4),
    ...
    e.define("select2/selection/allowClear", ["jquery", "../keys", "../utils"], function(i, s, a) {
        ...
        e.prototype.update = function(e, t) {
            ...
            0 < this.$selection.find(".select2-selection__placeholder").length || 0 === t.length || (e = this.$selection.find(".select2-selection__rendered").attr("id"),
    ...
    e.define("select2/selection/selectionCss", ["../utils"], function(n) {
        ...
        return e.prototype.render = function(e) {
            ...
            return -1 !== t.indexOf(":all:") && (t = t.replace(":all:", ""),
    ...
    e.define("select2/data/select", ["./base", "../utils", "jquery"], function(e, a, l) {
        ...
        n.prototype.select = function(i) {
            var e, o = this;
            i.selected = !0,
            null != i.element && "option" === i.element.tagName.toLowerCase() ? (i.element.selected = !0,
        ...
        n.prototype.unselect = function(i) {
            var o = this;
            this.$element.prop("multiple") && (i.selected = !1,
            null != i.element && "option" === i.element.tagName.toLowerCase() ? (i.element.selected = !1,
    ...
    e.define("select2/data/array", ["./select", "../utils", "jquery"], function(e, t, c) {
        ...
        s.prototype.convertToOptions = function(e) {
            ...
            for (var o = 0; o < e.length; o++) {
                ...
                a = c.extend(!0, {}, l, a),
                a = this.option(a),
                r.replaceWith(a)) : (r = this.option(l),
                l.children && (a = this.convertToOptions(l.children),
                r.append(a)),
                i.push(r))
            }
            return i
    ...
    e.define("select2/data/ajax", ["./array", "../utils", "jquery"], function(e, t, o) {
        ...
        n.prototype.query = function(t, n) {
            var s = this
              , i = (null != this._request && ("function" == typeof this._request.abort && this._request.abort(),
            this._request = null),
            o.extend({
                type: "GET"
            }, this.ajaxOptions));
    ...
    e.define("select2/data/tags", ["jquery"], function(t) {
        ...
        return e.prototype.query = function(e, c, u) {
            var d = this;
            this._removeOldTags(),
            null == c.term || null != c.page ? e.call(this, c, u) : e.call(this, c, function e(t, n) {
    ...
    e.define("select2/data/tokenizer", ["jquery"], function(c) {
        ...
        e.prototype.query = function(e, t, n) {
            ...
            var i = this.tokenizer(t, this.options, function(e) {
                ...
                }).length || ((e = s.option(t)).attr("data-select2-tag", !0),
                s._removeOldTags(),
                s.addOptions([e])),
                s.trigger("select", {
                    data: t
        ...
        e.prototype.tokenizer = function(e, t, n, s) {
            ...
            ; r < o.length; ) {
                var l = o[r];
                -1 === i.indexOf(l) ? r++ : (l = o.substr(0, r),
                null == (l = a(c.extend({}, t, {
                    term: l
                }))) ? r++ : (s(l),
                o = o.substr(r + 1) || "",
    ...
    e.define("select2/dropdown/selectOnClose", ["../utils"], function(n) {
        ...
        e.prototype._handleSelectOnClose = function(e, t) {
            if (t && null != t.originalSelect2Event) {
                ...
                if ("select" === t._type || "unselect" === t._type)
                    return
            }
    ...
    e.define("select2/options", ["jquery", "./defaults", "./utils"], function(c, n, u) {
        ...
        return e.prototype.fromElement = function(e) {
            var t = ["select2"]
              , n = (null == this.options.multiple && (this.options.multiple = e.prop("multiple")),
    ...
    e.define("select2/core", ["jquery", "./options", "./utils", "./keys"], function(t, i, o, s) {
        function r(e, t) {
            ...
            var t = e.attr("tabindex") || 0
              , t = (o.StoreData(e[0], "old-tabindex", t),
            e.attr("tabindex", "-1"),
            this.options.get("dataAdapter"))
              , t = (this.dataAdapter = new t(e,this.options),
            this.render())
              , n = (this._placeContainer(t),
            this.options.get("selectionAdapter"))
              , n = (this.selection = new n(e,this.options),
            this.$selection = this.selection.render(),
            this.selection.position(this.$selection, t),
            this.options.get("dropdownAdapter"))
              , n = (this.dropdown = new n(e,this.options),
            this.$dropdown = this.dropdown.render(),
            this.dropdown.position(this.$dropdown, t),
            this.options.get("resultsAdapter"))
              , s = (this.results = new n(e,this.options,this.dataAdapter),
        ...
        r.prototype._resolveWidth = function(e, t) {
            ...
            if ("resolve" == t)
                return null != (s = this._resolveWidth(e, "style")) ? s : this._resolveWidth(e, "element");
            if ("element" == t)

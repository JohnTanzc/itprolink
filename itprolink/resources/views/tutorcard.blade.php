...
@section('content')
<link rel="stylesheet" href="{{ asset('css/tutorcard.css') }}">
@include('pages.nav')
...
<div class="container">
    <div class="row align-items-center">
        <div class="col-md-6">
            <div class="mb-3">
                <h5 class="card-title">Tutors <span class="text">(834)</span></h5>
            </div>
        </div>
        <div class="col-md-6">
    ...
    <div class="row g-0 align-items-center pb-4">
        <div class="col-sm-6">
            <div><p class="showing">Showing 1 to 10 of 57 entries</p></div>
        </div>
        <div class="col-sm-6">

                            ...
                            <div class="menu-wrapper">
                                ...
                                <div class="nav-right-button d-flex align-items-center">
                                    <div class="user-action-wrap d-flex align-items-center">
                                                    ...
                                                    <ul class="cart-dropdown-menu after-none">
                                                        <li class="media media-card">
                                                            <a href="lesson-details.html" class="media-img">
                                                                <img class="me-3" src="images/small-img-3.jpg"
                                                                    alt="Course thumbnail image" />
                                                            </a>
                                                            <div class="media-body">
                                                                <h5>
                                                                    <a href="lesson-details.html">The Complete JavaScript
                                                                        Course 2021: From
                                                                        Zero to Expert!</a>
                                                                </h5>
                                                        ...
                                                        <li class="media media-card">
                                                            <a href="lesson-details.html" class="media-img">
                                                                <img class="me-3" src="images/small-img-4.jpg"
                                                                    alt="Course thumbnail image" />
                                                            </a>
                                                            <div class="media-body">
                                                                <h5>
                                                    ...
                                                    <ul class="cart-dropdown-menu after-none">
                                                        <li class="media media-card">
                                                            <a href="shopping-cart.html" class="media-img">
                                                                <img class="me-3" src="images/small-img.jpg"
                                                                    alt="Cart image" />
                                                            </a>
                                                            <div class="media-body">
                                                                <h5>
                                                                    <a href="shopping-cart.html">The Complete JavaScript
                                                                        Course 2021: From
                                                                        Zero to Expert!</a>
                                                                </h5>
                                        ...
                                        <!-- end shop-cart -->
                                        <div class="shop-cart wishlist-cart pe-3 me-3 border-right border-right-gray">
                                            <ul>
                                                <li>
                                                    ...
                                                    <ul class="cart-dropdown-menu after-none">
                                                        <li>
                                                            <div class="media media-card">
                                                                ...
                                                                <div class="media-body">
                                                                    <h5>
                                                                        <a href="course-details.html">The Complete
                                                ...
                                                <li>
                                                    ...
                                                    <ul
                                                        ...
                                                        <li class="menu-heading-block d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <h4>
                                                                    <a href="teacher-detail.html" class="text-black">Alex
                                                                        Smith</a>
                                                                </h4>
                                                                <span
        ...
        <div class="off-canvas-menu dashboard-off-canvas-menu off--canvas-menu custom-scrollbar-styled pt-20px">
            ...
            <ul class="generic-list-item off-canvas-menu-list off--canvas-menu-list pt-35px">
                <li class="page-active">
                    <a href="dashboard.html"><svg class="me-2" xmlns="http://www.w3.org/2000/svg" height="18px"
                ...
                <li>
                    <a href="dashboard-profile.html"><svg class="me-2" xmlns="http://www.w3.org/2000/svg"
                ...
                <li>
                    <a href="dashboard-courses.html"><svg class="me-2" xmlns="http://www.w3.org/2000/svg"
                            height="18px" viewBox="0 0 24 24" width="18px">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                            <path
                ...
                <li>
                    <a href="dashboard-quiz.html"><svg class="me-2" xmlns="http://www.w3.org/2000/svg"
                ...
                <li>
                    <a href="dashboard-bookmark.html"><svg class="me-2" xmlns="http://www.w3.org/2000/svg"
                            height="18px" viewBox="0 0 24 24" width="18px">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                ...
                <li>
                    <a href="dashboard-enrolled-courses.html"><svg class="me-2" xmlns="http://www.w3.org/2000/svg"
                            height="18px" viewBox="0 0 24 24" width="18px">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                            <path
                ...
                <li>
                    <a href="dashboard-message.html"><svg class="me-2" xmlns="http://www.w3.org/2000/svg"
                            height="18px" viewBox="0 0 24 24" width="18px">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                            <path
                ...
                <li>
                    <a href="dashboard-reviews.html"><svg class="me-2" xmlns="http://www.w3.org/2000/svg"
                            height="18px" viewBox="0 0 24 24" width="18px">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                            <path
                ...
                <li>
                    <a href="dashboard-earnings.html"><svg class="me-2" xmlns="http://www.w3.org/2000/svg"
                            height="18px" viewBox="0 0 24 24" width="18px">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                            <path
                ...
                <li>
                    <a href="dashboard-withdraw.html"><svg class="me-2" xmlns="http://www.w3.org/2000/svg"
                            height="18px" viewBox="0 0 24 24" width="18px">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                            <path
                ...
                <li>
                    <a href="dashboard-purchase-history.html"><svg class="me-2" xmlns="http://www.w3.org/2000/svg"
                            height="18px" viewBox="0 0 24 24" width="18px">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                            <path
                ...
                <li>
                    <a href="dashboard-submit-course.html"><svg class="me-2" xmlns="http://www.w3.org/2000/svg"
                            height="18px" viewBox="0 0 24 24" width="18px">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                ...
                <li>
                    <a href="dashboard-settings.html"><svg class="me-2" xmlns="http://www.w3.org/2000/svg"
                            height="18px" viewBox="0 0 24 24" width="18px">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                            <path
                ...
                <li>
                    <a href="index.html"><svg class="me-2" xmlns="http://www.w3.org/2000/svg" height="18px"
                            viewBox="0 0 24 24" width="18px">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                            <path
                ...
                <li>
                    <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#deleteModal"><svg
                            class="me-2" xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 0 24 24"
                            width="18px">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                            <path
                            ...
                            <div class="card-body">
                                ...
                                <div class="notification-body scrolled-box custom-scrollbar-styled">
                                    <a href="dashboard.html" class="media media-card align-items-center">
                                        <div class="icon-element icon-element-sm flex-shrink-0 bg-1 me-3 text-white">
                                            <i class="la la-bolt"></i>
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <a href="dashboard.html" class="media media-card align-items-center">
                                        <div class="icon-element icon-element-sm flex-shrink-0 bg-2 me-3 text-white">
                                            <i class="la la-lock"></i>
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <a href="dashboard.html" class="media media-card align-items-center">
                                        <div class="icon-element icon-element-sm flex-shrink-0 bg-3 me-3 text-white">
                                            <i class="la la-user"></i>
                                        </div>
                                        <div class="media-body">
                                            <h5 class="fs-15">
                                    ...
                                    <a href="dashboard.html" class="media media-card align-items-center">
                                        <div class="icon-element icon-element-sm flex-shrink-0 bg-4 me-3 text-white">
                                            <i class="la la-lock"></i>
                                        </div>
                                        <div class="media-body">
                                            <h5 class="fs-15">You changed password</h5>
                                    ...
                                    <a href="dashboard.html" class="media media-card align-items-center">
                                        <div class="icon-element icon-element-sm flex-shrink-0 bg-5 me-3 text-white">
                                            <i class="la la-user"></i>
                                        </div>
                                        <div class="media-body">
                                            <h5 class="fs-15">
                                    ...
                                    <a href="dashboard.html" class="media media-card align-items-center">
                                        <div class="icon-element icon-element-sm flex-shrink-0 bg-6 me-3 text-white">
                                    ...
                                    <a href="dashboard.html" class="media media-card align-items-center">
                                        <div class="icon-element icon-element-sm flex-shrink-0 bg-7 me-3 text-white">

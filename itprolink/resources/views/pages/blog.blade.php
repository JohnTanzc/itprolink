        ...
        <div class="feature-inner row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-blog-post">
                    <img src="{{ asset('template/img/blog-post/b1.jpg') }}" class="img-fluid" alt="" />
            ...
            <div class="col-lg-4 col-md-6 mt--160">
                <div class="single-blog-post">
                    <img src="{{ asset('template/img/blog-post/b2.jpg') }}" class="img-fluid" alt="" />
                    <div class="overlay"></div>
                    <div class="top-text">
                        <p>29th, oct, 2018</p>
                        <p>121 likes</p>
            ...
            <div class="col-lg-4 col-md-6 mt--260">
                <div class="single-blog-post">
                    <img src="{{ asset('template/img/blog-post/b3.jpg') }}" class="img-fluid" alt="" />
                    <div class="overlay"></div>
                    <div class="top-text">
                        <p>29th, oct, 2018</p>
                        <p>121 likes</p>

                    ...
                    <div class="owl-carousel video-carousel">
                        <div class="single-video">
                            <div class="video-part">
                                <img class="img-fluid" src="{{ asset('template/img/video-img.jpg') }}" alt="">
                                <div class="overlay"></div>
                                <a class="popup-youtube play-btn" href="https://www.youtube.com/watch?v=VufDd-QL1c0">
                                    <img class="play-icon" src="template/img/play-btn.png" alt="">
                                </a>
                            </div>
                        ...
                        <div class="single-video">
                            <div class="video-part">
                                <img class="img-fluid" src="{{ asset('template/img/video-img.jpg') }}" alt="">
                                <div class="overlay"></div>
                                <a class="popup-youtube play-btn" href="https://www.youtube.com/watch?v=oMYRtBT-HEA">
                                    <img class="play-icon" src="template/img/play-btn.png" alt="">
                                </a>
                            </div>
                            <h4 class="text-white mb-20 mt-30">Learn Angular js Course for Legendary Persons</h4>

    ...
    <section class="contact-area section--padding position-relative">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 responsive-column-half">
                    <div class="info-box">
                        ...
                        <p class="info__text">
                            East Poblacion, South, N.Bacalso S National Hwy, City of Naga, Cebu
                        </p>
                    </div>
                    <!-- end info-box -->
                </div>
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="info-box">
                        <div class="info-overlay"></div>
                        <div class="icon-element mx-auto shadow-sm">
                            <svg class="svg-icon-color-2" width="40" version="1.1" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <p class="info__text">itprolinked@gmail.com</p>
                        <p class="info__text">itprolinked@gmail.com</p>
                    </div>
                    <!-- end info-box -->
                </div>
                    ...
                    <div class="info-box">
                        ...
                        <div class="icon-element mx-auto shadow-sm">
                            <svg class="svg-icon-color-3" width="40" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                x="0px" y="0px" viewBox="0 0 473.806 473.806" xml:space="preserve">
                                <g>
                                    <g>
                                        <path
                        ...
                        <p class="info__text">(+63) 9690940143</p>
                        <p class="info__text">(+63) 9690940143</p>
                    </div>
                    <!-- end info-box -->
                </div>
                        ...
                        <div class="card-body">
                            <form method="post" action="php/contact.php" class="contact-form">
                                ...
                                <div class="input-box">
                                    ...
                                    <div class="form-group">
                                        <textarea id="message" class="form-control form--control ps-4" name="message" rows="5"
            ...
            {{-- <div class="row pt-30px">
                <div class="col-lg-12">
                    <div class="map-container">
                        ...
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3425.6461100067177!2d123.75004017470211!3d10.204127063900534!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x33a97853a1ef0a53%3A0x33c142d07a44658a!2sProfessional%20Academy%20of%20the%20Philippines!5e1!3m2!1sen!2sph!4v1731328159741!5m2!1sen!2sph"
            ...
            {{-- <link rel="stylesheet" href="https://unpkg.com/leaflet@1.7.1/dist/leaflet.css" />
                    ...
                    <script>
                        // Initialize the map and set the view to the desired location
                        var map = L.map('map').setView([10.2041, 123.7586], 15); // Set to coordinates for City of Naga, Cebu
                        ...
                        L.marker([10.2041, 123.7586]).addTo(map)
                            .bindPopup("<b>Professional Academy of the Philippines</b><br>City of Naga, Cebu")
                            .openPopup();
                    </script>
                    <!-- end map-container --> --}}
        </div>

    ...
    <div class="container">
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item text-center shadow-none rounded-0 bg-transparent">
                    <div class="card-body p-0">
                                ...
                                <g>
                                    <g>
                                        <path style="fill: #f0bc5e"
                                            d="M62,55H34V42c0-1.105,0.895-2,2-2h24c1.105,0,2,0.895,2,2V55z"></path>
                                    </g>
                                </g>
                                <g>
                                    <path style="fill: #f0bc5e"
                        ...
                        <p class="card-text">
                            Learn IT skills in fields like programming and data analysis with courses for all levels.
                        </p>
                    </div>
                    <!-- end card-body -->
                </div>
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item text-center shadow-none rounded-0 bg-transparent">
                    <div class="card-body p-0">
                        ...
                        <p class="card-text">
                            Study at your own pace, anytime and anywhere, with a schedule that fits your lifestyle.
                        </p>
                    </div>
                    <!-- end card-body -->
                </div>
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item text-center shadow-none rounded-0 bg-transparent">
                    <div class="card-body p-0">
                        ...
                        <p class="card-text">
                            Connect with passionate IT mentors and fresh graduates ready to guide you to success.
                        </p>
                    </div>
                    <!-- end card-body -->
                </div>
        ...
        @guest
            <div class="btn-box d-flex flex-wrap align-items-center justify-content-center pt-3">
                <div class="me-4">
                    <p class="pb-2">Are you an instructor?</p>
                    <a href="{{ route('user.register') }}" class="btn theme-btn theme-btn-sm lh-24"><i
                            class="la la-user me-1"></i>Start Teaching</a>
                </div>
                <div>
                    <p class="pb-2">Are you a student?</p>
                    <a href="{{ route('user.register') }}" class="btn theme-btn theme-btn-sm lh-24"><i
                            class="la la-file-text-o me-1"></i>Start Learning</a>
                </div>
            </div>
        @endguest
    </div>

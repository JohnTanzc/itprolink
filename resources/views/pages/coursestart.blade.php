<section class="category-area bg-gray section-padding text-center">
    <div class="container">
        ...
        <div class="row pt-50px">
                ...
                <div class="flip-box">
                    <div class="flip-box-front">
                        <img src="{{ asset('template/images/img-loading.png') }}"
                            data-src="{{ asset('template/images/img1.png') }}" alt="" class="flip-img lazy" />
                        <a href="#" class="flip-content d-flex align-items-center justify-content-center">
                            <div>
                                <h3 class="flip-title mb-1">Web Development
                                    <br>&<br>Design
                                </h3>
                                <p class="flip-subtitle"></p>
                            </div>
                        </a><!-- end flip-content -->
                    </div>
                    <!-- end flip-box-front -->
                        ...
                        <a href="#" class="flip-content d-flex align-items-center justify-content-center">
                            <div>
                                <div class="icon-element icon-element-md mx-auto mb-3">
                                    <svg class="svg-icon-color-1" width="35" viewBox="0 0 512 512"
                                        ...
                                        <path
                                            d="m57.435 81.651a8.511 8.511 0 1 0 8.509 8.51 8.52 8.52 0 0 0 -8.509-8.51z" />
                                        <path
                                            d="m89.091 98.672a8.511 8.511 0 1 0 -8.511-8.511 8.521 8.521 0 0 0 8.511 8.511z" />
                                        <path
                                            d="m121.748 81.651a8.511 8.511 0 1 0 8.51 8.51 8.521 8.521 0 0 0 -8.51-8.51z" />
                                        <path
                                            d="m41 163.317a6 6 0 0 0 -6 6v84.572a6 6 0 0 0 12 0v-84.572a6 6 0 0 0 -6-6z" />
                                        <path
                                            d="m41 140.053a6 6 0 0 0 -6 6v4.614a6 6 0 0 0 12 0v-4.614a6 6 0 0 0 -6-6z" />
                                        <path
                                            d="m55.037 272.757a6 6 0 0 0 0 8.486l44.721 44.721a6 6 0 0 0 8.484-8.485l-40.477-40.479 40.477-40.479a6 6 0 0 0 -8.484-8.485z" />
                                        <path
                                            d="m171.271 325.964a6 6 0 0 0 8.484 0l44.721-44.721a6 6 0 0 0 0-8.486l-44.721-44.721a6 6 0 0 0 -8.484 8.485l40.477 40.479-40.477 40.479a6 6 0 0 0 0 8.485z" />
                                        <path
                                            d="m120.85 355.264a5.989 5.989 0 0 0 7.241-4.423l35-144.864a6 6 0 0 0 -11.664-2.818l-35 144.864a6 6 0 0 0 4.423 7.241z" />
                                        <path d="m255.808 223h3a6 6 0 0 0 0-12h-3a6 6 0 0 0 0 12z" />
                                        <path d="m288.717 223h10.318a6 6 0 1 0 0-12h-10.318a6 6 0 0 0 0 12z" />
                                        <path d="m329.432 223h123.289a6 6 0 0 0 0-12h-123.289a6 6 0 0 0 0 12z" />
                                        <path d="m255.808 263h3a6 6 0 1 0 0-12h-3a6 6 0 0 0 0 12z" />
                                        <path d="m288.717 263h10.318a6 6 0 1 0 0-12h-10.318a6 6 0 0 0 0 12z" />
                                        <path d="m329.432 263h123.289a6 6 0 0 0 0-12h-123.289a6 6 0 0 0 0 12z" />
                                        <path d="m255.808 303h3a6 6 0 1 0 0-12h-3a6 6 0 0 0 0 12z" />
                                        <path d="m288.717 303h10.318a6 6 0 1 0 0-12h-10.318a6 6 0 0 0 0 12z" />
                                        <path d="m329.432 303h123.289a6 6 0 0 0 0-12h-123.289a6 6 0 0 0 0 12z" />
                                        <path d="m255.808 343h3a6 6 0 1 0 0-12h-3a6 6 0 0 0 0 12z" />
                                        <path d="m288.717 343h10.318a6 6 0 1 0 0-12h-10.318a6 6 0 0 0 0 12z" />
                                        <path d="m329.432 343h123.289a6 6 0 0 0 0-12h-123.289a6 6 0 0 0 0 12z" />
                                    </svg>
                                </div>
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="flip-box">
                    <div class="flip-box-front">
                        <img src="{{ asset('template/images/img-loading.png') }}"
                            data-src="{{ asset('template/images/img2.png') }}" alt="" class="flip-img lazy" />
                        <a href="#" class="flip-content d-flex align-items-center justify-content-center">
                            <div>
                                <h3 class="flip-title mb-1">Data<br>Analysis</h3>
                                <p class="flip-subtitle"></p>
                            </div>
                        </a><!-- end flip-content -->
                    </div>
                    ...
                    <div class="flip-box-back">
                        ...
                        <a href="#" class="flip-content d-flex align-items-center justify-content-center">
                            <div>
                                <div class="icon-element icon-element-md mx-auto mb-3">
                                    <svg class="svg-icon-color-2" width="35" viewBox="0 0 512 512"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                            <g>
                                                <path
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="flip-box">
                    <div class="flip-box-front">
                        <img src="{{ asset('template/images/img-loading.png') }}"
                            data-src="{{ asset('template/images/img3.png') }}" alt="" class="flip-img lazy" />
                        <a href="#" class="flip-content d-flex align-items-center justify-content-center">
                            <div>
                                <h3 class="flip-title mb-1">IT Support<br>&<br>Troubleshooting</h3>
                                <p class="flip-subtitle"></p>
                            </div>
                        </a><!-- end flip-content -->
                    </div>
                    ...
                    <div class="flip-box-back">
                        ...
                        <a href="#" class="flip-content d-flex align-items-center justify-content-center">
                            <div>
                                <div class="icon-element icon-element-md mx-auto mb-3">
                                    <svg class="svg-icon-color-3" width="35" viewBox="-39 0 492 492.00126"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
            ...
            <div class="col-lg-3 responsive-column-half">
                <div class="flip-box">
                    <div class="flip-box-front">
                        <img src="{{ asset('template/images/img-loading.png') }}"
                            data-src="{{ asset('template/images/img4.png') }}" alt="" class="flip-img lazy" />
                        <a href="#" class="flip-content d-flex align-items-center justify-content-center">
                            <div>
                                <h3 class="flip-title mb-1">UI/UX</h3>
                                <p class="flip-subtitle"></p>
                            </div>
                        </a><!-- end flip-content -->
                    </div>
                    ...
                    <div class="flip-box-back">
                        ...
                        <a href="#" class="flip-content d-flex align-items-center justify-content-center">
                            <div>
                                <div class="icon-element icon-element-md mx-auto mb-3">
                                    <svg class="svg-icon-color-4" width="35" viewBox="0 0 64 64"
                                        xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="col-lg-3 responsive-column-half">
                <div class="flip-box">
                    <div class="flip-box-front">
                        <img src="{{ asset('template/images/img-loading.png') }}"
                            data-src="{{ asset('template/images/img5.png') }}" alt=""
                            class="flip-img lazy" />
                        <a href="#" class="flip-content d-flex align-items-center justify-content-center">
                            <div>
                                <h3 class="flip-title mb-1">Graphic Design</h3>
                                <p class="flip-subtitle"></p>
                            </div>
                        </a><!-- end flip-content -->
                    </div>
                            ...
                            <div>
                                <div class="icon-element icon-element-md mx-auto mb-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="35"
                                        height="35" class="svg-icon-color-5">
                                        <!-- Monitor Body -->
                                        <rect x="8" y="8" width="48" height="32" rx="4"
                                            ry="4" fill="#d1d5db" stroke="#6b7280" stroke-width="2"></rect>
                                        <!-- Screen -->
                                        <rect x="12" y="12" width="40" height="24" rx="2"
                                            ry="2" fill="#ffffff" stroke="#6b7280" stroke-width="1"></rect>
                                        <!-- Base -->
                                        <rect x="24" y="42" width="16" height="4" fill="#6b7280"></rect>
                                        <!-- Stand -->
                                        <rect x="30" y="38" width="4" height="4" fill="#6b7280"></rect>
                                        <!-- Power Button -->
                                        <circle cx="48" cy="12" r="1" fill="#f43f5e"></circle>
                                    </svg>
            ...
            <div class="col-lg-3 responsive-column-half">
                <div class="flip-box">
                    <div class="flip-box-front">
                        <img src="{{ asset('template/images/img-loading.png') }}"
                            data-src="{{ asset('template/images/img6.png') }}" alt=""
                            class="flip-img lazy" />
                        <a href="#" class="flip-content d-flex align-items-center justify-content-center">
                            <div>
                                <h3 class="flip-title mb-1">Character Animation</h3>
                                <p class="flip-subtitle"></p>
                            </div>
                        </a><!-- end flip-content -->
                    </div>
                    ...
                    <div class="flip-box-back">
                        ...
                        <a href="#" class="flip-content d-flex align-items-center justify-content-center">
                            <div>
                                <div class="icon-element icon-element-md mx-auto mb-3">
                                    <svg class="svg-icon-color-6" width="32" viewBox="0 0 512.00003 512"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
            ...
            <div class="col-lg-3 responsive-column-half">
                <div class="flip-box">
                    <div class="flip-box-front">
                        <img src="{{ asset('template/images/img-loading.png') }}"
                            data-src="{{ asset('template/images/img7.png') }}" alt=""
                            class="flip-img lazy" />
                        <a href="#" class="flip-content d-flex align-items-center justify-content-center">
                            <div>
                                <h3 class="flip-title mb-1">Game Design</h3>
                                <p class="flip-subtitle"></p>
                            </div>
                        </a><!-- end flip-content -->
                    </div>
                    ...
                    <div class="flip-box-back">
                        ...
                        <a href="#" class="flip-content d-flex align-items-center justify-content-center">
                            <div>
                                <div class="icon-element icon-element-md mx-auto mb-3">
                                    <svg class="svg-icon-color-7" width="32"
                                        viewBox="-19 -19 625.33477 625.33477" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                        ...
                                        <path
                                            d="m67.851562 260.433594c-6.015624-10.976563-11.53125-22.007813-16.398437-32.796875l-18.207031 8.214843c5.078125 11.253907 10.828125 22.757813 17.09375 34.183594zm0 0" />
                                        <path
                                            d="m9.960938 168.515625c2.503906 10.699219 5.546874 21.269531 9.117187 31.664063l18.902344-6.457032c-3.351563-9.757812-6.214844-19.675781-8.5625-29.714844zm0 0" />
                                        <path
                                        ...
                                        <path
                                            d="m531.53125 301.214844-17.351562 9.890625c4.808593 8.4375 9.34375 16.9375 13.480468 25.261719l17.890625-8.878907c-4.300781-8.671875-9.015625-17.507812-14.019531-26.273437zm0 0" />
                                        <path
                                        ...
                                        <path
                                            d="m235.800781 553.121094c11.261719-5.074219 22.761719-10.832032 34.179688-17.089844l-9.59375-17.511719c-10.972657 6.011719-22.007813 11.53125-32.800781 16.394531zm0 0" />
                                        <path
                                            d="m168.464844 576.410156c10.703125-2.503906 21.273437-5.546875 31.664062-9.117187l-6.457031-18.90625c-9.753906 3.355469-19.671875 6.210937-29.714844 8.566406zm0 0" />
                                        <path
        ...
        <div class="view-more-box pt-4 text-center">
            <a href="{{ route('course') }}" class="btn theme-btn">View all Category <i

                ...
                <div class="media media-card align-items-center pb-4">
                    <div class="media-img media--img media-img-md rounded-full">
                        <img class="rounded-full"
                            ...
                            style="width: 92px; height: 92px; object-fit: cover; border-radius: 50%;" />
                    </div>
                    <div class="media-body">
                        <h2 class="section__title fs-30">{{ $tutor->fname }} {{ $tutor->lname }}</h2>
                        <span class="d-block lh-18 pt-1 pb-2">Joined {{ $tutor->created_at->diffForHumans() }}</span>
                                    ...
                                    <div class="skills">
                                        <div class="skill">
                                            <div class="d-flex flex-wrap align-items-center justify-content-between">
                                                <span class="fs-16 text-black font-weight-semi-bold pe-3">HTML</span>
                                                <span>99%</span>
                                            </div>
                                        ...
                                        <div class="skill">
                                            <div class="d-flex flex-wrap align-items-center justify-content-between">
                                                <span class="fs-16 text-black font-weight-semi-bold pe-3">CSS</span>
                                                <span>99%</span>
                                            </div>
                                            <div class="progress_bg">
                                                <div class="progress_bar"></div>
                                        ...
                                        <div class="skill">
                                            <div class="d-flex flex-wrap align-items-center justify-content-between">
                                                <span class="fs-16 text-black font-weight-semi-bold pe-3">Javascript</span>
                                                <span>95%</span>
                                            </div>
                                            <div class="progress_bg">
                                                <div class="progress_bar"></div>

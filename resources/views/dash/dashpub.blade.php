                ...
                <div class="media media-card align-items-center pb-4">
                    <div class="media-img media--img media-img-md rounded-full">
                        <img class="rounded-full"
                            ...
                            style="width: 93px; height: 93px; object-fit: cover; border-radius: 50%;" />
                    </div>
                    <div class="media-body">
                        ...
                        <p class="lh-18">{{ ucwords($user->role) }}</p>
                    </div>
                </div>
                <!-- end media -->
                    ...
                    <div class="col-lg-4 responsive-column-half">
                        <div class="counter-item">
                            ...
                            <h4 class="counter__title counter text-color-2 fs-35">
                                ...
                                @if ($courses->isNotEmpty() && isset($courses[0]))
                                    {{ $courses[0]->enrolledCount ?? 0 }}
                                @else
                                    <p>No courses available or no enrollees yet.</p>
                                @endif
                                    ...
                                    <div class="col-lg-4 col-sm-6 mb-30 pb-5">
                                        <a class="card" href="#">
                                            ...
                                            <div class="card-body text-center">
                                                ...
                                                <p class="card-text text-sm">{{ $tutor->edu ?? 'No education information available.' }}</p>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-lg-4 col-sm-6 mb-30 pb-5">
                                        <a class="card" href="#">
                                            ...
                                            <div class="card-body text-center">
                                                ...
                                                <p class="card-text text-sm">{{ $tutor->career ?? 'No education information available.' }}</p>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-lg-4 col-sm-6 mb-30 pb-5">
                                        <a class="card" href="#">
                                            <div class="box-shadow bg-white rounded-circle mx-auto text-center"
                                                style="width: 90px; height: 90px; margin-top: -45px;"><svg class="mt-3" fill="#EC5252"
                                                    height="60px" width="60px" version="1.1" id="Layer_1"
                                                    xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <div class="card-body text-center">
                                                ...
                                                <p class="card-text text">{{ $tutor->career ?? 'No education information available.' }}</p>
                                            </div>
                                        </a>
                                    </div>
                                </div>
    ...
    <section class="course-area section-padding">
        <div class="container">
            ...
            <div class="row">
                ...
                @if ((Auth::user()->role == 'tutor' && $course->user_id == Auth::user()->id) || Auth::user()->role == 'tutee')

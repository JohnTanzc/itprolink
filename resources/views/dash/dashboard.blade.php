...
@section('content')
    ...
    <div class="dashboard-content-wrap">
        ...
        <div class="dashboard-heading mb-5">
            <h3 class="fs-22 font-weight-semi-bold">{{ ucfirst($user->role) }} Dashboard</h3>
        </div>
        <div class="row">
            {{-- Active Course --}}
                    ...
                    <div class="card card-item dashboard-info-card">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="ps-4">
                                ...
                                <h5 class="card-title pt-2 fs-26">{{ $totalCourses }}</h5>
                            </div>
                        </div>
                        <!-- end card-body -->
                    </div>
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="card card-item dashboard-info-card">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="ps-4">
                                <p class="card-text fs-18">Active Students</p>
                                <h5 class="card-title pt-2 fs-26">{{ $activeTutees }}</h5>
                            </div>
                        </div>
                        <!-- end card-body -->
                    </div>
                        ...
                        <div class="card-body d-flex align-items-center">
                            <div class="icon-element flex-shrink-0 bg-2 text-white">
                                <svg fill="white" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    viewBox="0 13 256 240" enable-background="new 0 0 256 240" xml:space="preserve"
                            ...
                            <div class="ps-4">
                                <p class="card-text fs-18">Active Tutors</p>
                                <h5 class="card-title pt-2 fs-26">{{ $activeTutors }}</h5>
                            </div>
                        </div>
                        <!-- end card-body -->
                    </div>
                    ...
                    <div class="card card-item dashboard-info-card">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="ps-4">
                                ...
                                <h5 class="card-title pt-2 fs-26">{{ $totalTutees }}</h5>
                            </div>
                        </div>
                        <!-- end card-body -->
                    </div>
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="card card-item dashboard-info-card">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="ps-4">
                                <p class="card-text fs-18">Total Tutors</p>
                                <h5 class="card-title pt-2 fs-26">{{ $totalTutors }}</h5>
                            </div>
                        </div>
                        <!-- end card-body -->
                    </div>
            ...
            {{-- <div class="dropdown">
                <button class="btn btn-light p-0" type="button" id="notificationMenuButton" data-bs-toggle="dropdown"
                    aria-expanded="false">
                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                        style="width: 24px; height: 24px;">
                        <circle cx="5" cy="12" r="2" fill="#233D63"></circle>
                        <circle cx="12" cy="12" r="2" fill="#233D63"></circle>
                        <circle cx="19" cy="12" r="2" fill="#233D63"></circle>
                    </svg>
                </button>
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="notificationMenuButton">
                    ...
                    <li>
                        <form action="{{ route('notifications.deleteAll') }}" method="POST">
                            @csrf
                            <button type="submit" class="dropdown-item text-danger">Delete all</button>
                        </form>
                    </li>
                </ul>
            </div> --}}
                ...
                <div class="card card-item">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center pb-4">
                            ...
                            <div class="dropdown">
                                <button class="btn btn-light p-0" type="button" id="notificationMenuButton"
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="notificationMenuButton">
                                    ...
                                    <!-- Delete All -->
                                    <li>
                                        <form id="delete-all-form" action="{{ route('notifications.deleteAll') }}"
                                            method="POST">
                                            @csrf
                                            <button type="submit" class="dropdown-item text-danger"
                                                id="delete-all-btn">Delete all</button>
                                        </form>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="notification-body scrolled-box custom-scrollbar-styled">
                            @foreach ($notifications as $notification)
                                <a href="javascript:void(0);"
                                    class="media media-card align-items-center notification-item" data-bs-toggle="modal"
                                    data-bs-target="#notificationModal"
                                    data-message="{{ $notification->data['message'] }}"
                                    data-time="{{ \Carbon\Carbon::parse($notification->created_at)->toDayDateTimeString() }}"
                                    data-id="{{ $notification->id }}">
                                    <div class="icon-element icon-element-sm flex-shrink-0 bg-1 me-3 text-white">
                                        <i class="la la-bolt"></i>
                                    </div>
                                    <div class="media-body">
                                        <h5 class="fs-15">{{ $notification->data['message'] }}</h5>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.delete-notification-btn').forEach(function(button) {
                button.addEventListener('click', function() {
                    ...
                    const url = `/notifications/delete/${notificationId}`; // Build the URL
                            ...
                            fetch(url, {
                                ...
                                .then(data => {
                                    if (data.success) {
                                        ...
                                        this.closest('.notification-item').remove(); // Remove notification from the DOM
                                    } else {
            ...
            // Handle "Delete All" functionality with SweetAlert
            document.getElementById('delete-all-btn').addEventListener('click', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        document.getElementById('delete-all-form').submit(); // Submit the form to delete all
                    }
                });
            });
        });
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const modalTime = document.getElementById('notificationTime');

            notificationItems.forEach(item => {
                item.addEventListener('click', () => {
                    modalMessage.textContent = item.getAttribute('data-message');
                    modalTime.textContent = item.getAttribute('data-time');
                });
            });
        });
    </script>
